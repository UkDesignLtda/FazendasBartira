...
<div class='container'>
    <label for='endereco' >Address:</label><br/>
...
<div class='container'>
    <label for='escolaridade' >School Level:</label><br/>
    <select name="escolaridade" id="escolaridade" value='<?php echo $formproc->SafeDisplay('escolaridade') ?>'>
    	<option value="">Choose..</option>
        <option value="medio">High School</option>
      	<option value="superior">College</option>
       	<option value="pos-graduado">Postgraduate</option>
    </select>
</div>
...
<div class='container'>
    <label for='photo' >Resume (PDF):</label><br/>
...
// <![CDATA[
	...
	frmvalidator.addValidation("resume","file_extn=doc;docx;pdf;txt","Please upload only .pdf files");
// ]]>
</script>
</body>
</html>