...
<div class='container'>
    ...
    <input type='text' name='assunto' id='assunto' value='<?php echo $formproc->SafeDisplay('assunto') ?>' maxlength="50" /><br/>
    <span id='contactus_assunto_errorloc' class='error'></span>
</div>
<div class='container'>
